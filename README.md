...
A real-time Simulation of a Black Hole! Implemented Ray Marching in Java (JDK 21) and GLSL, using GLFW and OpenGL.
...
Use at your own risk, see [Disclaimers](#Disclaimers). A double click executable `.exe` file **for Windows** is available in the latest Release.
...
GPUs this was tested with:
- Nvidia RTX 5060 Ti: smooth, at least 100FPS at 2560x1440     
- Intel UHD Graphics (of the i5-10210U): laggy visual and input at 800x600
